...
# to do: get rid of blank option, not useful
    ...
    def get_pose_key_angles(self, frame, wantBlank = False):
        ...
        for pair in self.POSE_PAIRS:
            ...
            if POINTS[idFrom] and POINTS[idTo]:
                ...
                cv.line(frame, POINTS[idFrom], POINTS[idTo], (0, 255, 0), 3) #last value is thickness
